const liquidez_balanco = [
    {
        "identificacao": {
            ...
            "nome_empresarial": "ECTARE PAY SERVICOS DE GESTAO DE PAGAMENTOS S/A"
        },
        "liquidez_indices": {
...
class liquidez{
    constructor(liquidez_balanco){
        this.identificacao = liquidez_balanco[0].identificacao;
    }
}

const indices = new liquidez(liquidez_balanco);
console.log(indices.identificacao.nome_empresarial);